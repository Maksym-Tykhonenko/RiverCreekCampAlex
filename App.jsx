...
import ProductScreen from './RiverCamp/RiverCampScreens/ProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://quick-bridge-box.site/`;
  const URL_IDENTIFAIRE = `dQ0x5mDp`;
  ...
  OneSignal.initialize('8ab4a27f-5f03-49d1-9ca6-96766805510b');
